...
```
2. Compute the cheese per capita over time:
This dataset contains information about dairy product stocks across the country over time. We could use population data over time to find out how today's stocks compare to the past.Access population data here:https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1710000501
